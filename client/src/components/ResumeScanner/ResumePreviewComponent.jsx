...
import { FileText, Loader2, CheckCircle, AlertCircle, XCircle } from 'lucide-react';
    ...
    return (
      <div className="bg-white p-6 rounded-lg border-2 border-green-500 h-96 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black font-medium mb-2">Scanning Resume...</p>
          <p className="text-gray-600 text-sm">Analyzing ATS compatibility</p>
        </div>
      </div>
    );
  }
